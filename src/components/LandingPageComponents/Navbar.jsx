  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-2">
        {/* Logo */}
        <Link href="/python-mastery-pack" className="flex items-center gap-2">
          <Image
            src="/logo.webp"
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <Link href="/python-mastery-pack" className="block text-gray-800 font-medium hover:text-blue-600 transition">
              Home
            </Link>
