        ...
        <label className="flex items-start gap-2 cursor-pointer">
          ...
          <div>
            <p className="font-semibold text-gray-800 text-sm">
              Add <a href="/30-days-javascript?from=checkout"  className="underline text-blue-600">30 Days of JavaScript Course</a> to my order.
            </p>
            <p className="text-xs text-gray-700 mt-1">
            Master JavaScript from basics to advanced with bonus guides like HTML, CSS, 100+ JS Projects, and more. 🚀
            </p>
            <p className="text-green-600 font-medium text-sm mt-1">Add for ₹199 only</p>
          </div>
        </label>
      </div>
