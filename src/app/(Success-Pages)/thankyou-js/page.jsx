      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
        <div className="bg-white max-w-md w-full rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your 30 days javascript pack is now ready to download.
          </p>
  
          {/* Download Button */}
          <a
            href="https://drive.google.com/drive/folders/1veiv54vM5rqb-YSgSZXw-YMBuOYIIGyV?usp=sharing" // update this
